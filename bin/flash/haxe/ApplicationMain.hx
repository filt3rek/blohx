...
class ApplicationMain {
	...
	public static function main () {
		...
		//nme.Lib.setPackage("filt3rek", "BloHx", "ftb.app.blohx", "1.0.0");
	...
	private static function start ():Void {
		...
		var hasMain = false;
		var mainClass = Type.resolveClass ("ftb.app.blohx.Main");
...
class ApplicationMain {
	...
	public static function main () {
		...
		for (methodName in Type.getClassFields (ftb.app.blohx.Main)) {
		...
		if (hasMain) {
			...
			Reflect.callMethod (ftb.app.blohx.Main, Reflect.field (ftb.app.blohx.Main, "main"), []);
...
@:keep class DocumentClass extends ftb.app.blohx.Main { }
